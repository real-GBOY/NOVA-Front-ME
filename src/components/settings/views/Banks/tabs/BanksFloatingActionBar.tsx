...
interface BanksFloatingActionBarProps {
   selectedCount: number;
   selectedRows: Bank[];
   onEdit: (bank: Bank) => void;
   onDelete: (banks: Bank[]) => void;
   resetSignal?: unknown;
}
...
function BanksFloatingActionBar({
   selectedCount,
   selectedRows,
   onEdit,
   onDelete,
   resetSignal,
}: BanksFloatingActionBarProps) {
   ...
   const singleActions: ActionButton[] = [
      {
         id: "delete",
         label: t("banks.floatingBar.delete"),
      ...
      {
         id: "edit",
         label: t("banks.floatingBar.edit"),
         icon: <Edit size={20} />,
   ...
   const multiActions: ActionButton[] = [
      {
         id: "delete",
         label: t("banks.floatingBar.deleteMultiple"),
         icon: <Trash size={20} className="fill-danger" />,
         onClick: () => onDelete(displayRows),
         variant: "danger",
      },
               ...
               <div
                  ...
                  <div className="flex items-center gap-2 px-3 py-2">
                     <p className="text-sm text-text-strong whitespace-nowrap">
                        ({displayCount}) {t("banks.floatingBar.selected")}
                     </p>
                  </div>
...
export default BanksFloatingActionBar;
