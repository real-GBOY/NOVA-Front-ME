...
interface ServicesFilterDropdownProps {
	onApply: (filters: ServicesFilters) => void;
...
function ServicesFilterDropdown({
	...
	const handleResetField = (field: keyof ServicesFilters) => {
			...
			<FilterSection
				...
				<SearchableMultiSelect
					...
					availableItems={STATUS_OPTIONS.map((s) => ({
						...s,
						label: t(`serviceCatalog.status.${s.id}`),
					}))}
...
export default ServicesFilterDropdown;
