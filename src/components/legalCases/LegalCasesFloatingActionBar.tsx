...
import { Trash, PenToSquare } from "@/Icons";
import { cn } from "@/utilities/index";
import type { LegalCase } from "./data";
import { motion } from "framer-motion";
import { usePermissions } from "@/contexts/PermissionContext";

interface LegalCasesFloatingActionBarProps {
	selectedCount: number;
	selectedRows: LegalCase[];
	onDelete: (cases: LegalCase[]) => void;
...
function LegalCasesFloatingActionBar({
	selectedCount,
	selectedRows,
	onDelete,
	onEdit,
}: LegalCasesFloatingActionBarProps) {
	...
	// Permission checks
	const canDelete = can("delete_legal_case");
	const canUpdate = can("update_legal_case");
...
export default LegalCasesFloatingActionBar;
