...
function StepResidency({
   ...
   const RESIDENCY_STATUS_OPTIONS = useMemo(
      () => [
         ...
         {
            id: "Cancelled",
            label: t("members.residencyDetails.statusOptions.cancelled"),
         },
      ],
      [t]
   );
         ...
         render: (form) => (
            <div className="flex gap-4 w-full">
               <div className="flex-1 flex flex-col gap-1">
                  ...
                  <DatePicker
                     placeholder={t(
                        "members.residencyDetails.issueDatePlaceholder"
                     )}
                     value={
                     ...
                     onChange={(value: Date) => {
                        ...
                        form.setValue("residencyIssueDate", isoString, {
                           shouldValidate: true,
                           shouldDirty: true,
                        });
                        updateFormData("residencyIssueDate", isoString);
                     }}
                  />
               ...
               <div className="flex-1 flex flex-col gap-1">
                  ...
                  <DatePicker
                     placeholder={t(
                        "members.residencyDetails.expiryDatePlaceholder"
                     )}
                     ...
                     onChange={(value: Date) => {
                        const isoString = value.toISOString();
                        form.setValue("residencyExpiryDate", isoString, {
                           shouldValidate: true,
                           shouldDirty: true,
                        });
                        updateFormData("residencyExpiryDate", isoString);
                     }}
                  />
   ...
   return (
      <div className="bg-background border rounded-2xl border-border flex flex-col w-full p-6 gap-8">
         <div className="flex flex-col gap-6">
            ...
            <GenericForm
               schema={stepResidencyInfoSchema}
