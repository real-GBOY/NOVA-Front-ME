...
import { stepWorkInfoSchema } from "@/utilities/schemas/memberSchema";
...
function StepWorkInfo({
      ...
      () => [
         {
            id: "full_time",
            label: t(
               "members.workInfo.employmentTypeOptions.fullTime"
            ),
         },
         {
            id: "part_time",
            label: t(
               "members.workInfo.employmentTypeOptions.partTime"
            ),
         },
         {
            id: "contract",
            label: t(
               "members.workInfo.employmentTypeOptions.contract"
            ),
         },
         {
            id: "intern",
         ...
         },
         {
            id: "temporary",
            label: t(
               "members.workInfo.employmentTypeOptions.temporary"
            ),
         },
      ],
      [t]
   );
   // Auto-generate member ID (in real app, this would come from backend)
   const memberId = useMemo(
      () =>
         `#EM${Math.floor(Math.random() * 10000)
            .toString()
            .padStart(4, "0")}`,
      []
   );
   ...
   const fields: FieldConfig[] = [
               ...
               <div className="flex-1">
                  <GenericFormField
                     fieldConfig={{
                        ...
                        placeholder: t(
                           "members.workInfo.jobTitlePlaceholder"
                        ),
                     }}
                     form={form}
            ...
            <div className="flex flex-col gap-3">
               <Checkbox
                  ...
                  onChange={(e) => {
                     ...
                     if (!checked) {
                        // Clear manager value when unchecked
            ...
            <div className="flex flex-col gap-3">
               <Checkbox
                  ...
                  onChange={(e) => {
                     ...
                     if (!checked) {
                        // Clear shiftId value when unchecked
      ...
      // Employment Type
      {
         ...
         placeholder: t(
            "members.workInfo.employmentTypePlaceholder"
         ),
         ...
         render: (form) => (
            <div className="flex flex-col gap-1">
               ...
               <DatePicker
                  ...
                  placeholder={t(
                     "members.workInfo.startDatePlaceholder"
                  )}
               />
      ...
      // Probation Period
      {
         ...
         placeholder: t(
            "members.workInfo.probationPeriodPlaceholder"
         ),
      },
      // Member ID (Read-only)
      {
         name: "memberId",
         type: "custom",
         label: t("members.workInfo.memberId"),
         render: () => (
            <div className="flex flex-col gap-1">
               <label className="block text-sm font-medium text-text-strong">
                  {t("members.workInfo.memberId")}
               </label>
               <div className="px-3 py-2.5 text-sm rounded-lg bg-bg-weak text-text-soft">
                  {memberId}
               </div>
            </div>
         ),
